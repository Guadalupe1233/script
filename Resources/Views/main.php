...
<html lang="en-us" class="no-js">
	...
	<head>
		<meta charset="utf-8">
		<title>OOPS - Flat 404 Not found</title>
        ...
        <link rel="apple-touch-icon" sizes="144x144" href="Resources/Images/favicon-retina-ipad.png">
        <!-- Retina iPhone Touch Icon-->
        <link rel="apple-touch-icon" sizes="114x114" href="Resources/Images/favicon-retina-iphone.png">
        <!-- Standard iPad Touch Icon--> 
        <link rel="apple-touch-icon" sizes="72x72" href="Resources/Images/favicon-standard-ipad.png">
        <!-- Standard iPhone Touch Icon--> 
        <link rel="apple-touch-icon" sizes="57x57" href="Resources/Images/favicon-standard-iphone.png">
	...
	<body class="bubble">
        ...
        <a href="#" class="logo-link" title="back home">
            ...
            <img src="Resources/Images/logo.png" class="logo" alt="Company's logo" />
